...
public interface ProductService {
    ...
    PageResponse<List<ProductResponse>> getProductsByCategory(String category, int pageNumber, int size);
    PageResponse<List<ProductResponse>> getProductsByCreator(String name, int pageNumber, int size);
